...
Category {
  ...
  SubShader {
    Pass {
      ...
      //#include "Assets/Smew Brush/UnitySDK/Assets/TiltBrush/Assets/Shaders/Include/Brush.cginc"
	  ...
	  half4 GetRainbowColor( half2 texcoord)
      {
      ...
      fixed4 frag (v2f i) : SV_Target
      {
        ...
        half4 tex =  GetRainbowColor(i.texcoord.xy);
        tex = i.color * tex * exp(_EmissionGain * 3.0f);

        half4 color = half4(tex.rgb * tex.a, 1.0);
