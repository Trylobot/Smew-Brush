...
#else
        float waveform_r = .15 * sin( -20 * i.unbloomedColor.r * _Time.w/6 + i.texcoord.x * 100 * i.unbloomedColor.r);
        float waveform_g = .15 * sin( -30 * i.unbloomedColor.g * _Time.w/6 + i.texcoord.x * 100 * i.unbloomedColor.g);
        float waveform_b = .15 * sin( -40 * i.unbloomedColor.b * _Time.w/6 + i.texcoord.x * 100 * i.unbloomedColor.b);
#endif
